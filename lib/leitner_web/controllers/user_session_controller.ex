defmodule LeitnerWeb.UserSessionController do
  ...
  defp create(conn, %{"user" => user_params}, info) do
    ...
    email =
      if is_nil(user) do
        case Accounts.get_user_by_username(email_or_username) do
          nil ->
            nil
    ...
    if user = Accounts.get_user_by_email_and_password(email, password) do
      ...
      # In order to prevent user enumeration attacks, don't disclose whether the email_or_username is registered.
      conn
